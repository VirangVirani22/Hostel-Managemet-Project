...
<link rel="icon" type="img/logo.png" href="img/logo.png">
	...
	<title>Single Room Reciept</title>
 ...
 <section id="contact">
 	...
 	<div class="panel panel-primary">
 	  <div class="panel-heading">
 			<h3 class="panel-title"> Confirmation Reciept for Single seater room with A.C </h3>
 	  </div>
 		...
 		<form  action="confirmroomreciept.jsp" method="post"  >
