...
<%-- 
    ...
    Document   : confirmnonroomreciept
    Created on : Apr 19, 2016, 8:34:42 PM
...
<html>
    ...
    <body>
       ...
       Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/parimal","root","Parimal@123");
        ...
        String query="SELECT * FROM singlewithnonac WHERE reg='"+reg+"';";
       ...
       <% 
            ...
            request.setAttribute("msg", msg);
                RequestDispatcher rd=request.getRequestDispatcher("srnac.jsp");
