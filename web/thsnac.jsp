...
<link rel="icon" type="img/logo.png" href="img/logo.png">
	...
	<title>Three seater Room Reciept</title>
 ...
 <section id="contact">
 	...
 	<div class="panel panel-primary">
 	  <div class="panel-heading">
 			<h3 class="panel-title"> Confirmation Reciept for Three seater room with Non A.C </h3>
 	  </div>
 		...
 		<form  action="confirmthreenonroomreciept.jsp" method="post"  >
