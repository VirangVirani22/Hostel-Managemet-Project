...
<link rel="icon" type="img/logo.png" href="img/logo.png">
	...
	<title>Confirm Two seater with A.C Room</title>
 ...
 <section id="contact">
 	...
 	<div class="panel panel-primary">
 	  <div class="panel-heading">
 			<h3 class="panel-title">Confirm Two seater with A.C Room </h3>
 	  </div>
 	  <div class="panel-body">
 		...
 		<form  action="confirmtworoomval.jsp" method="post" name="apply" >
