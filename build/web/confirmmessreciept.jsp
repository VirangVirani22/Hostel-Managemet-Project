...
<html>
    ...
    <body>
       ...
       Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/parimal","root","Parimal@123");
        ...
        String query="SELECT * FROM mess WHERE reg='"+reg+"';" ;
       ...
       if(rs.next())
        ...
        <TABLE BORDER="0" cellpadding="12" cellspacing="12" >
            ...
            <TR>  <TD><B>Room Type</B></TD> <TD><%= rs.getString(1) %></TD></TR>
              ...
              <TR>  <TD><B>Email</B></TD> <TD><%= rs.getString(6) %></TD></TR>
              <TR>  <TD><B>Contact no.</B></TD> <TD><%= rs.getString(7) %></TD></TR>
              <TR>  <TD><B>Address</B></TD> <TD><%= rs.getString(8) %></TD></TR>
              <TR>  <TD><B>Fee paid</B></TD> <TD><%= rs.getString(9) %></TD></TR>
              </TABLE>
       <BR>
       <% 
             }
            ...
            request.setAttribute("msg", msg);
                RequestDispatcher rd=request.getRequestDispatcher("me.jsp");
