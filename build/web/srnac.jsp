...
<link rel="icon" type="img/logo.png" href="img/logo.png">
	...
	<title>Single seater Room Reciept</title>
 ...
 <section id="contact">
 	...
 	<div class="panel panel-primary">
 	  <div class="panel-heading">
 			<h3 class="panel-title"> Confirmation Reciept for Single seater room with Non A.C </h3>
 	  </div>
 		...
 		<form  action="confirmnonroomreciept.jsp" method="post"  >
