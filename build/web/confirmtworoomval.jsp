...
<html>
    ...
    <body>
       ...
       Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/parimal","root","Parimal@123");
        ...
        String query="select count(*) from twowithac";
       ...
       ResultSet rs= pstmt.executeQuery();
        ...
        {     
            ...
            if(i<50)
                    {
             String sql="insert into twowithac (roomno,room,reg,name,branch,year,email,contact,address,fee) values('"+roomnum+"','"+room+"','"+reg+"','"+name+"','"+branch+"','"+year+"','"+email+"','"+contact+"','"+address+"','"+fee+"')";
           
             PreparedStatement pst1=con.prepareStatement(sql);
             pst1.executeUpdate(); 
             
            RequestDispatcher rd=request.getRequestDispatcher("confirmtworoomreciept.jsp");
