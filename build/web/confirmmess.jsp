 ...
 <section id="contact">
 	...
 	<div class="panel panel-primary">
 	  <div class="panel-heading">
 			<h3 class="panel-title">Confirm Mess </h3>
 	  </div>
 	  <div class="panel-body">
 		...
 		<form  action="confirmmessval.jsp" method="post" name="apply" >
 				...
 				<label for="">Type of Room</label>
                                <select name="room">
                                    ...
                                    <option value="Two seater with non A.C" >Two seater with non A.C</option>
 			...
 			<div class="form-group">
 				...
 				<input type="text" class="form-control" id="" name="room"  size="8" required/>
 			</div>
